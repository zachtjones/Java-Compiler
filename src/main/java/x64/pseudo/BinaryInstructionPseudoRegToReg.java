 ...
 */
public abstract class BinaryInstructionPseudoRegToReg implements PseudoInstruction {
	@NotNull private final X64PreservedRegister source;
	@NotNull private final X64NativeRegister destination;
	private final String name;


	public BinaryInstructionPseudoRegToReg(String name, @NotNull X64PreservedRegister source,
