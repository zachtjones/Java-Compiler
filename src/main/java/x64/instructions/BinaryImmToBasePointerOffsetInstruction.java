...
public abstract class BinaryImmToBasePointerOffsetInstruction extends Instruction {
     ...
     */
    public BinaryImmToBasePointerOffsetInstruction(@NotNull String name, @NotNull Immediate source,
