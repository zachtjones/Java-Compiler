...
public class SignExtendBasePointerOffsetToReg extends Instruction {

	private final String rep; // how this is represented

	public SignExtendBasePointerOffsetToReg(@NotNull BasePointerOffset source, @NotNull X64Register destination,
